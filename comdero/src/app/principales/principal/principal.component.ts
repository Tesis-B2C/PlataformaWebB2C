...
export class PrincipalComponent implements OnInit {
  ...
  constructor(private route: ActivatedRoute, private router: Router,private _agenteServicio: AgenteServicio,private _tiendaServicio:TiendaServicio, private _categoriaServicio: CategoriaServicio) {
